...
def noun_label_shaping():
    ...
    noun_result_path = os.path.normpath(os.path.join(base_path, r'temp\noun_label.csv'))   # 物体認識のラベル結果（名詞ラベル）
    video_path = os.path.normpath(os.path.join(base_path, r'temp\cut'))                          # 動画データのパス
    noun_en_path = os.path.normpath(os.path.join(base_path, r'C:\Users\fukuyori\CM_Analysis\Data\Label\noun_label(en).txt'))     # データセットのラベル群（英語）
    noun_ja_path = os.path.normpath(os.path.join(base_path, r'C:\Users\fukuyori\CM_Analysis\Data\Label\noun_label(ja).txt'))     # データセットのラベル群（日本語）
    trans_table_path = os.path.normpath(os.path.join(base_path, r'C:\Users\fukuyori\CM_Analysis\Data\Label\noun_screening.csv')) # スクリーニング用の対応表
...
def verb_label_shaping():
    base_path = os.path.dirname(os.path.abspath(__file__))  # スクリプト実行ディレクトリ
    verb_result_path = os.path.normpath(os.path.join(base_path, r'temp\verb_label.json'))  # 動作認識のラベル結果（名詞ラベル）
    verb_en_path = os.path.normpath(os.path.join(base_path, r'C:\Users\fukuyori\CM_Analysis\Data\Label\verb_label(en).txt'))     # データセットのラベル群（英語）
    verb_ja_path = os.path.normpath(os.path.join(base_path, r'C:\Users\fukuyori\CM_Analysis\Data\Label\verb_label(ja).txt'))     # データセットのラベル群（日本語）
    trans_table_path = os.path.normpath(os.path.join(base_path, r'C:\Users\fukuyori\CM_Analysis\Data\Label\verb_screening.csv')) # スクリーニング用の対応表
...
def label_shaping():
    ...
    """
    base_path = os.path.dirname(os.path.abspath(__file__))  # スクリプト実行ディレクトリ
    cut_point_path = os.path.normpath(os.path.join(base_path, r'temp\cut_point.csv'))   # 動作認識のラベル結果（名詞ラベル）
    merged_label_path = os.path.normpath(os.path.join(base_path, r'temp\merged_label.csv'))   # 動作認識のラベル結果（名詞ラベル）
