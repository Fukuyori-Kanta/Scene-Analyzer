...
def label_shaping():
    ...
    """
    base_path = os.path.dirname(os.path.abspath(__file__))  # スクリプト実行ディレクトリ
    cut_point_path = os.path.normpath(os.path.join(base_path, r'temp\cut_point.csv'))   # カット点データ
    merged_label_path = os.path.normpath(os.path.join(base_path, r'temp\merged_label.csv'))   # 結合ラベルデータ格納パス
