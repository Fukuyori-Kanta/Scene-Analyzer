...
def cut_segmentation(files, result_cut_path):
    """
    ...
    # 保存先の中身を初期化
    # --------------------------------------------------
    dest_folder_create(result_cut_path)
    ...
    for video_id in video_id_list:
        ...
        dest_path = os.path.join(result_cut_path, video_name)   # 各動画のカット分割結果の保存先
        #dest_path = result_cut_path # 各動画のカット分割結果の保存先
